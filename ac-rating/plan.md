...
| — | M1 | pending | — | — | Maintenance (вне основного плана): ratelimit 403→429, atomic save для MethodologyVersion, удаление stub raw_values_migration. ТЗ: `ac-rating/tz/M1-cleanup.md` |
| — | D | pending | — | 🧑‍💼 | Дизайн-сессия параллельно: клод-дизайн делает wireframes. Блокирует Ф6A/B/C. |
