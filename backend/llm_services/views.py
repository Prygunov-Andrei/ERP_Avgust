...
# parse_specification view removed (E28): ISMeta теперь вызывает
# Recognition Service напрямую (POST /v1/parse/spec на порт 8003). См.
# ismeta/backend/apps/estimate/services/pdf_import_service.py и
# backend/api_public/tasks.py → _parse_all_files.
